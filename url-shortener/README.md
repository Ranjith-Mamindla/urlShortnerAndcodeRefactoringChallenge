...
- Short codes are generated randomly with 6 alphanumeric characters.
- URLs are validated using Python’s `urllib.parse` before shortening.
- Thread-safe operations ensured with a global lock around shared dictionary.
- Error handling includes 400 for invalid URLs and 404 for unknown short codes.
- Tests cover all core endpoints and major error cases.
